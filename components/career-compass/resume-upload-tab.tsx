...
// Import the ReadableMemoizedMarkdown component instead of ReactMarkdown
import { ReadableMemoizedMarkdown } from "@/components/ui/memoized-markdown-chatbot"
        ...
        {analysisResult && (
          ...
          >
            ...
            {(!structuredData || resultsView === "text") && (
              ...
              >
                {/* Replace ReactMarkdown with ReadableMemoizedMarkdown */}
                <ReadableMemoizedMarkdown content={analysisResult} id="resume-analysis" />
              </motion.div>
            )}
