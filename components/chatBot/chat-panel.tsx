  ...
  return (
    <div
      className={cn(
        ...
        messages.length > 0
          ? 'sticky bottom-0 bg-background/80 backdrop-blur-md z-10 pb-4 pt-2'
          : ''
      )}
    >
      {messages.length === 0 && (
      ...
      <form
        ...
        className={cn(
          'w-full mx-auto',
          messages.length > 0 ? 'px-4' : 'px-6'
        )}
      >
        <div className="relative flex flex-col w-full gap-2 bg-muted rounded-3xl border border-input shadow-sm">
          <Textarea
            ref={inputRef}
            name="input"
            rows={2}
          ...
          <div className="flex items-center justify-between p-3">
            <div className="flex items-center gap-2">
              <div className="search-toggle-wrapper group">
                <SearchModeToggle />
              </div>
            </div>
            <div className="flex items-center gap-2">
